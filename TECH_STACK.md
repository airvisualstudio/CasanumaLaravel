...
| **Spatie Permission** | 8.x | Role-Based Access Control (RBAC) & granular permission gates |
...
| `spatie/laravel-permission` | 8.3.0 | `require` | Permission handling for Laravel 12 and up |
